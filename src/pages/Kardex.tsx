...
export default function Kardex() {
  ...
  return <div className="fade-up">
    ...
    <div className="page-card page-card--pad" style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'end', marginBottom: 16 }}>
      <label className="field">Producto
        <div style={{ position: 'relative' }}>
          <input className="control" style={{ width: 280 }} value={selected ? `${selected.name} · ${selected.code}` : query} placeholder="Buscar producto..." onChange={event => { setSelected(null); setQuery(event.target.value); setShowResults(true); }} onFocus={() => setShowResults(true)} />
